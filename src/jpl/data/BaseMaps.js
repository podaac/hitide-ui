define([
    ...
    "jpl/events/MapEvent"
], function(declare, lang, topic, request, on, xhr, Layer, MakeSingletonUtil, Config, LayerEvent, MapEvent) {
    /**
        ...
        declare("gov.nasa.jpl.data.BaseMaps", [], /** @lends jpl.data.BaseMaps.prototype */ {
            ...
            constructor: function() {
                if (!this.mapsLoaded) {
                    ...
                    this.url = this.config.basemapServiceURL;
