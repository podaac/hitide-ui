//>>built
define(["require", "dojo/on", "dojo/Evented", "dojo/uacss", "dojo/_base/declare", "dojo/_base/lang", "dojo/_base/Deferred", "dojo/_base/array", "dojo/text!./GeocodeReview/templates/Review.html", "dojo/i18n!../nls/jsapi", "dojo/store/Memory", "dojo/string", "dojo/dom-style", "dijit/_WidgetBase", "dijit/_OnDijitClickMixin", "dijit/_TemplatedMixin", "dijit/_WidgetsInTemplateMixin", "dijit/form/Button", "dijit/layout/BorderContainer", "dijit/layout/ContentPane", "dijit/layout/StackContainer", "dijit/layout/StackController", "dgrid/OnDemandGrid", "dgrid/Selection", "dgrid/Keyboard", "dgrid/editor", "dgrid/extensions/DijitRegistry", "dgrid/extensions/ColumnHider", "../graphic", "../geometry/Extent", "../geometry/Point", "../geometry/webMercatorUtils", "../symbols/SimpleMarkerSymbol", "../symbols/PictureMarkerSymbol", "../tasks/query", "../layers/FeatureLayer", "../layers/GraphicsLayer", "../request", "../arcgis/utils", "../kernel"],
    function(z, h, A, O, p, e, B, t, C, f, k, l, q, D, E, F, G, P, Q, R, S, T, H, I, J, r, K, L, m, u, M, v, U, s, w, n, N, x, y, V) {
        return p([D, E, F, G, A], {
            ...
            constructor: function(a, b) {
                p.safeMixin(this, a);
                this.StandardGrid = p([K, H, I, J, r, L]);
                ...
                this.matchedUC =
                    f.widgets.geocodeReview.matchedUC;
                ...
                this.highlightGraphic || (this.highlightGraphic = new s(this.basePath.toString() + "images/EsriYellowPinCircle26.png",
                    26, 26), this.highlightGraphic.setOffset(0, 12));
                this._keywordMap = {};
                this._keywordArray = [];
            ...
            postCreate: function() {
                ...
                this._generateGrids();
                this.graphicsLayer = new N;
                this.map.addLayer(this.graphicsLayer);
                this._listenerHandles = [this.StackControllerNode.on("selectChild", e.hitch(this, function() {
                        this.clearGridSelection();
                        this.StackContainerNode.selectedChildWidget && (this.currentTab = this.StackContainerNode.selectedChildWidget,
            ...
            resize: function() {
                var a = q.get(this.domNode, "height"),
                    b = q.get(dojo.byId(this.headerID), "height");
            ...
            _queryFeatureLayer: function() {
                ...
                this._featureLayer.queryFeatures(g).then(e.hitch(this, function(e) {
                    for (a = 0; a < e.features.length; a++) e.features[a].attributes.updated = !1, e.features[a].attributes.reviewed = !1, e.features[a].attributes.featureType = "matched", d = e.features[a].attributes, b = new M(e.features[a].geometry.getLongitude(), e.features[a].geometry.getLatitude()),
