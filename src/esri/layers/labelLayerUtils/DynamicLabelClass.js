//>>built
define(["dojo/_base/declare", "dojo/_base/lang", "dojo/_base/connect", "dojo/has", "dojox/gfx/_base", "../../kernel", "../../lang", "../../SpatialReference", "../GraphicsLayer", "../LabelClass", "../../renderers/SimpleRenderer", "../../geometry/Geometry", "../../geometry/Extent", "../../geometry/Point", "../../geometry/Polyline", "../../geometry/Polygon", "../../symbols/TextSymbol", "../../symbols/ShieldLabelSymbol", "../../symbols/SimpleLineSymbol"], function(E, I, J, K, L, M, N, O, F, P, Q, R, G, S, T, H, U, V, W) {
    return E(F, {
        ...
        _process: function(e) {
            ...
            for (e = this._preparedLabels.length - 1; 0 <= e; e--) {
                var a = this._preparedLabels[e],
                    ...
                    b = d && void 0 !== d.pointPriorities ? d.pointPriorities : "AboveRight",
                    k = [2, 2, 1, 3, 0, 2, 3, 3, 2];
                "AboveLeft" == b ? k = [1, 2, 2, 2, 0, 3, 2, 3, 3] : "AboveCenter" == b ? k = [2, 1, 2, 2, 0, 2, 3, 3, 3] : "AboveRight" == b ? k = [2, 2, 1, 3, 0, 2, 3, 3, 2] : "CenterLeft" == b ? k = [2, 2, 3, 1, 0, 3, 2, 2, 3] : "CenterCenter" == b ? k = [0, 0, 0, 0, 1, 0, 0, 0, 0] : "CenterRight" == b ? k = [3, 2,
                    2, 3, 0, 1, 3, 2, 2
                ] : "BelowLeft" == b ? k = [2, 3, 3, 2, 0, 3, 1, 2, 2] : "BelowCenter" == b ? k = [3, 3, 3, 2, 0, 2, 2, 1, 2] : "BelowRight" == b && (k = [3, 3, 2, 3, 0, 2, 2, 2, 1]);
                var m = d && void 0 !== d.labelRotation ? d.labelRotation : !0,
                    b = a.angle * (Math.PI / 180);
                d = d && void 0 !== d.howManyLabels ? d.howManyLabels : "OneLabel";
                if ("point" == a.geometry.type) this._generatePointPositions(a, a.geometry.x, a.geometry.y, a.text, b, g, f, a.symbolWidth, a.symbolHeight, k);
                    ...
                    h = a.geometry;
                    for (c = 0; c < h.points.length; c++) this._generatePointPositions(a,
                        h.points[c][0], h.points[c][1], a.text, b, g, f, a.symbolWidth, a.symbolHeight, k)
                } else "polyline" == a.geometry.type ? this._generateLinePositions(a, a.geometry, a.text, g, f, 2 * a.symbolHeight + f, h, c, m) : "polygon" == a.geometry.type && this._generatePolygonPositions(a, d, a.geometry, a.text, b, g, f)
            }
        ...
        _generatePointPositions: function(e, d, a, f, g, h, c, b, k, m) {
            ...
            for (p = 1; 3 >= p; p++)
                for (l = 1; 9 >= l; l++)
                    if (m[l - 1] == p) switch (l) {
                        case 1:
                            if (this._findPlace(e, f, d - b, a + k, g, h,
                                c)) return;
                            break;
                        case 2:
        ...
        _generateLinePositions: function(e, d, a,
            f, g, h, c, b, k) {
                ...
                for (; 0 <= q && q < r - 1;) {
                    for (l = q; l < r; l++) {
                        ...
                        if (w * w + y * y > m) {
                            ...
                            "Below" == b && (z = -h * B *
                                this._scale, A = -h * C * this._scale);
                            if (1 == l - q) {
                                if (this._clipLine(t, v, s[l][0], s[l][1]) && (t = this._x1 - this._x0, n = this._y1 - this._y0, t * t + n * n > m && (l = Math.atan2(n, t), w = f / 2 + 2 * g, v = w * this._scale * Math.cos(l), w = w * this._scale * Math.sin(l), "PlaceAtStart" == c ? (t = this._x0 + v, n = this._y0 + w) : "PlaceAtEnd" == c ? (t = this._x1 - v, n = this._y1 - w) : (t = this._x0 + t / 2, n = this._y0 + n / 2), this._findPlace(e, a, t - z, n + A, k ? -l : 0, f, g)))) return
                            } else {
                                var D = 0;
                                for (n = q; n <= l; n++) D = Math.max(D, Math.abs((s[n][1] - v) * C - (s[n][0] - t) * B));
                                if (D < g && this._findPlace(e, a,
                                    t + w / 2 - z, v + y / 2 + A, k ? -x : 0, f, g)) return
                            }
                            break
                        }
                    }
        ...
        _generatePolygonPositions: function(e, d, a, f, g, h, c) {
            var b;
            if ("ManyLabels" == d)
                for (d = 0; d < a.rings.length; d++) b = this._findCentroid(a.rings[d], this._xmin, this._ymin, this._xmax, this._ymax), this._findPlace(e, f, b[0], b[1], g, h, c);
            else {
                ...
                for (d = 0; 10 > d; d++) {
                    ...
                    if (this._findPlace(e, f, b[0], b[1], g,
                        h, c)) break;
                    b = this._findCentroidForFeature(a, this._xmin, k - (m + c / 4), this._xmax, k - (m - c / 4));
        ...
        _fillBuffer: function(e, d, a) {
            for (var f = e.length - 1, g = e[0][1] >= e[f][1] ? 1 : -1, h = 0; h <= f; h++) {
                var c = h,
                    b = h + 1;
                h == f && (b = 0);
                var k = e[c][0],
                    ...
                    b = e[b][1],
                    p = b >= c ? 1 : -1;
                if (c <= a[1] && a[1] <= b || b <= a[1] && a[1] <= c) a[1] != c && a[1] != b ? (d.push((a[1] - c) * (m - k) / (b - c) + k), g = p) : a[1] == c && a[1] != b ? (g != p && d.push(k), g = p) : a[1] != c && a[1] == b ?
                    (d.push(m), g = p) : a[1] == c && a[1] == b && (1 == g && d.push(k), d.push(m), g = p)
            }
        },
        _sortBuffer: function(e, d, a, f) {
            ...
            if (0 < g) {
                for (var h = 0, c = d = 0; c < g - 1; c += 2) {
                    ...
                    !(e[c] <= a && e[c + 1] <= a) && (!(e[c] >= f && e[c + 1] >= f) && b > h) && (h = b, d = c)
                }
                g = e[d];
                e = e[d + 1];
                g > f && (g = f);
        ...
        _findPlace: function(e, d, a, f, g, h, c) {
            ...
            for (var b = 0; b < this._placedLabels.length; b++) {
                ...
                if (0 === g && 0 === k) {
                    ...
                    var s = new G(-h * this._scale, -c * this._scale, h * this._scale, c * this._scale, null),
                        r = 0,
                        q = 1;
        ...
        _clipLine: function(e, d, a, f) {
            for (var g = this._code(e, d), h = this._code(a, f); 0 !== g || 0 !== h;) {
                ...
                var c = a - e,
                    b = f - d;
                0 !== g ? (e < this._xmin ? (d += b * (this._xmin - e) / c, e = this._xmin) : e > this._xmax ? (d += b * (this._xmax - e) / c, e = this._xmax) : d < this._ymin ? (e += c * (this._ymin - d) / b, d = this._ymin) : d > this._ymax && (e += c * (this._ymax - d) / b, d = this._ymax), g = this._code(e, d)) : (a < this._xmin ? (f += b * (this._xmin - a) / c, a = this._xmin) : a > this._xmax ? (f += b * (this._xmax - a) / c, a = this._xmax) : f < this._ymin ? (a += c * (this._ymin - f) / b, f = this._ymin) : f > this._ymax && (a += c * (this._ymax - f) / b, f = this._ymax), h = this._code(a, f))
            }
            this._x0 = e;
            this._y0 = d;
            this._x1 = a;
