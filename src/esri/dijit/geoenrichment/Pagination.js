//>>built
define(["../../declare", "dojo/_base/lang", "dojox/mvc/Templated", "dojo/aspect", "dojo/dom-class", "dojo/dom-geometry", "dojo/dom-construct", "dojo/on", "dgrid/List", "dijit/_WidgetBase", "./AnimationHelper", "dojo/text!./templates/Pagination.html", "dijit/layout/ContentPane"], function(t, n, u, y, r, s, k, p, z, v, w, x) {
    return t("esri.dijit.geoenrichment.Pagination", [v, u], {
        ...
        _setCurrentPageAttr: function(a) {
            ...
            if (this.currentPage !== a) {
                ...
                a === this.currentPage + 1 ? (b.appendChild(g), this._slideAnim(b, e, ["Pagination_SlideAnim", "Pagination_SlideForward"])) : a === this.currentPage - 1 ? (b.insertBefore(g, b.firstChild), this._slideAnim(b, e, ["Pagination_SlideAnim", "Pagination_SlideBackward"])) : (b.appendChild(g), this.scrollAnim.start([{
                    node: e,
