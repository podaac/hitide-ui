...
define(["../../declare", "require", "dojo/_base/lang", "./BaseSelectComparison", "dojo/dom-construct", "dojo/number", "dojo/dom-class", "./utils", "./theme", "dojox/charting/Chart", "dojox/charting/axis2d/Default", "dojox/charting/plot2d/Bars", "dojox/charting/plot2d/Lines", "dojox/charting/action2d/Tooltip", "dojox/charting/action2d/Highlight", "dojox/charting/SimpleTheme", "dojo/i18n!../../nls/jsapi"], function(u, C, k, v, e, m, n, w, p, x, y, z, A, q, r, B, c) {
    ...
    return u("esri.dijit.geoenrichment.AgePyramid", [v], {
        ...
        _doUpdateUI: function() {
            ...
            this.maleIndices = [];
            this.femaleIndices = [];
            for (var b = a.length / 2, d = Number.NEGATIVE_INFINITY, f = Number.POSITIVE_INFINITY, s, t, g = !0, h = !0, l = 0; l < a.length; l++) {
                var e = l < b;
                e ? this.maleIndices.push(a[l]) : this.femaleIndices.push(a[l]);
                var c = this.getValueByIndex(0, a[l]);
                c > d ? (d = c, s = this.getFieldByIndex(a[l]).alias, g = e) : c < f && (f = c, t = this.getFieldByIndex(a[l]).alias, h = e)
            }
            ...
            this.expanded ? (f = this._getComparisonRow(), d = this.setSeriesData(this.chart.getSeries("male_lines"), f, this.maleIndices, -1), f = this.setSeriesData(this.chart.getSeries("female_lines"), f, this.femaleIndices, 1)) : (this.chart.getSeries("male_lines").update([]), this.chart.getSeries("female_lines").update([]), f = d = Number.NEGATIVE_INFINITY);
            this.extreme = w.getCeiling(Math.max(a, b, d, f), !0);
        ...
        getTooltip: function(a) {
            ...
            var c = this.getFeatureTitle(f),
                e = this.getFieldByIndex(d).alias;
            d = m.format(this.getValueByIndex(f, d), {
                places: 0
            });
            ...
            return "\x3cdiv class\x3d'AgePyramid_Tooltip_Content'\x3e\x3cspan style\x3d'font:" + b.font + "; color:" + b.color + ";'\x3e\x3cb\x3e" + c + "\x3c/b \x3e \x3cbr / \x3e " + e + "\x3cbr/\x3e" + d + " (" + a + ")\x3c/span\x3e\x3c/div\x3e"
        },
        setSeriesData: function(a, b, d, f) {
            for (var c = [], e =
                0, g = 0; g < d.length; g++) {
                var h = this.getValueByIndex(b, d[g]);
                c.push(h);
                e += h
            }
            b = Number.NEGATIVE_INFINITY;
            for (g = 0; g < d.length; g++) h = 100 * (c[g] / e), c[g] = h * f, h > b && (b = h);
            if ("lines" === a.plot)
                for (g = 0; g < c.length; g++) c[g] = {
                    x: c[g],
                    y: g + 1
                };
            a.update(c);
